...
#define HOST_IP_ADDR           SL_IPV4_VAL(172, 20, 10, 3)   // IP address of server to connect to
 ...
 */                     //Config IP is the same (wes' board testing)
#define CONFIG_IP       SL_IPV4_VAL(172,20,10,3)       /* Static IP to be configured */
...
#define HOST_IP_ADDR           SL_IPV4_VAL(192, 168, 43, 92)   // IP address of server to connect to
#define PORT_NUM               5001                     // Port number to be used
#define NO_OF_PACKETS          1                        // Number of packets to send out
 ...
 * Static IP address for host
 */                     //Config IP is the same (wes' board testing)
#define CONFIG_IP       SL_IPV4_VAL(192, 168, 43, 92)       /* Static IP to be configured */
#define AP_MASK         SL_IPV4_VAL(255,255,255,0)      /* Subnet Mask for the station */
#define AP_GATEWAY      SL_IPV4_VAL(192, 168, 43, 84)        /* Default Gateway address */
#define AP_DNS          SL_IPV4_VAL(192, 168, 43, 84)            /* DNS Server Address */
#define SL_STOP_TIMEOUT        0xFF
