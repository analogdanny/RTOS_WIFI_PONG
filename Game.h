...
#define myPlayer Host

semaphore_t CC3100Semaphore, LCDSemaphore, I2CSemaphore;
...
/*
 * Aperiodic Thread for EndOfGameHost that restarts the game.
 * */
void ButtonTap();
